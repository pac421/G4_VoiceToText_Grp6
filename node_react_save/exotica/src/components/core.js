...
class core extends React.Component {
    ...
    renderRecognitionOutput() {
        ...
        if(!this.state.recognitionOutput.length) return false;
        document.querySelector('#output').value = this.state.recognitionOutput.reverse().map((r) => {
            return r.text;
        });
        this.state.recognitionOutput.reverse();
        return false;
    }
